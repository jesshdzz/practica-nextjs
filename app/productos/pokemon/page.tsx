import { PokemonResponse, SimplePokemon } from "@/app/components/pokemon";
...
const respuesta = async (limit = 5, offset = 0): Promise<SimplePokemon[]> => {
    ...
    const data: PokemonResponse = await fetch(`https://pokeapi.co/api/v2/pokemon?limit=${limit}&offset=${offset}`).then((response) => response.json())
